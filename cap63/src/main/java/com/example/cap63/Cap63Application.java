package com.example.cap63;

import com.example.cap63.batch.TransactionApplierProcessor;
import com.example.cap63.batch.TransactionReader;
...
import com.example.cap63.domain.support.TransactionDaoSupport;
...
//				.build();
	...
	public static void main(String[] args) {
		...
		realArgs.add("summaryFile=file:/home/g3no/Escritorio/summary.csv");


		SpringApplication.run(Cap63Application.class, realArgs.toArray(new String[realArgs.size()]));
	}
